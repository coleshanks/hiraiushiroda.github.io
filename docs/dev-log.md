...
## 2026/06/07 
 - 目的:新しいページ作成
 - できたこと: ページの左右にあった黒線を削除(index.cssファイル)　エフェクト追加
 - 難しかったこと:新しいページは次回に持ち越し　コードが読み取れていない
 - 覚えること:index.css/app.cssの違い:index.cssはサイト全体の共通設定　app.cssはapp.jsxの専用設定
 - note:
 - 次回のタスク: 今回の復習　コード読み取り　ページ追加
